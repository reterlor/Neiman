...
"подходящих дробей" \! цепной дроби, давайте начнем с их доказательства.}
	...
	\begin{definition}
	{
		Цепная дробь полученная из отделения от $[a_0;a_1,...,a_n]$
...
\end{align}
\end{gather}
\noindent{Успех зависит от того, сможем ли мы показать что это взаимоотношение поддерживается и далее. Это содержание Теоремы 2.}
